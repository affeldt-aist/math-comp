...
(******************************************************************************)
(* NB: See CONTRIBUTING.md for a short introduction to HB commands.           *)
(*                                                                            *)
(* This file defines two "base" combinatorial structures:                     *)
(*      eqType == types with a decidable equality                             *)
(*             := Equality.type                                               *)
(*                Equality on an eqType is proof-irrelevant                   *)
...
(*          [eqType of T] == clone for T of the eqType inferred for T,        *)
(*                           possibly after unfolding some definitions        *)
(* * Sub                                                                      *)
(* ** Specific notations                                                      *)
(*   [isSub of S for S_val] == subtype for S where S_val : S -> T is the      *)
(*     first projection of a type S isomorphic to {x : T | P}                 *)
(*   [isSub for S_val] := [isSub of _ for S_val]                              *)
(*     It clones the canonical subType structure for S; if S_val is specified,*)
...
(*   inj_type injf == where injf : injective f with f : T -> T'               *)
(*                    where T : Type and T' is equipped with the structure we *)
(*                    want to equip f with                                    *)
(*    pcan_type fK == an Equality structure similarly derived from f and a    *)
(*                    left inverse partial function g and fK : pcancel f g    *)
(*     can_type fK == an Equality structure similarly derived from f and a    *)
(*                    left inverse function g and fK : cancel f g             *)
(*                                                                            *)
